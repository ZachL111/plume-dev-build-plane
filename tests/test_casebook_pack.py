"""Regression checks for the plume-dev-build-plane casebook."""
...
from casebook.harness import assert_expected, plume_dev_build_plane_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_dev_build_plane_summary(), assert_expected())
